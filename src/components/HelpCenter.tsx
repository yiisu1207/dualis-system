    ...
    articles: [
      {
        ...
        content: {
          ...
          faq: [
            ...
            { q: '¿Cómo agrego a alguien de mi equipo?', a: 'Ve a Configuración → Equipo → envía una invitación o comparte tu URL personalizada (ej: tuempresa.dualis.online) para que se registren.' },
          ],
        },
      },
      {
    ...
    articles: [
      {
        ...
        content: {
          ...
          buttons: [
            { name: 'URL Personalizada', what: 'URL única de tu empresa (ej: tuempresa.dualis.online). Compártela con quien quieres invitar. Se configura en Configuración > Empresa.' },
          ...
          faq: [
            { q: '¿Cómo invito a mi empleado?', a: 'Envíale una invitación desde Configuración → Equipo, o comparte tu URL personalizada (ej: tuempresa.dualis.online). Al registrarse, verás su solicitud para aprobarla.' },
    ...
    articles: [
      {
        ...
        content: {
          ...
          buttons: [
            ...
            { name: 'URL personalizada', what: 'Configura una URL única (ej: tuempresa.dualis.online) en Configuración > Empresa. Tus empleados pueden acceder directamente desde ahí.' },
