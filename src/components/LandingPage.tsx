  ...
  return (
    <div className="min-h-screen bg-[#020710] text-white overflow-x-hidden selection:bg-indigo-600/80 antialiased">
      <style>{`
        ...
        @keyframes slide-in-r{ from{opacity:0;transform:translateX(24px)} to{opacity:1;transform:translateX(0)} }
        @keyframes glow-pulse{ 0%,100%{box-shadow:0 0 50px -15px rgba(99,102,241,.35)} 50%{box-shadow:0 0 90px -10px rgba(99,102,241,.6)} }
        ...
        @keyframes grain     { 0%,100%{transform:translate(0)} 10%{transform:translate(-5%,-10%)} 30%{transform:translate(3%,-15%)} 50%{transform:translate(-15%,5%)} 70%{transform:translate(8%,2%)} 90%{transform:translate(-10%,10%)} }
        ...
        .float-b           { animation:float-y2 8s  cubic-bezier(.45,.05,.55,.95) infinite; animation-delay:-2.5s; }
        .float-c           { animation:float-y3 5s  cubic-bezier(.45,.05,.55,.95) infinite; animation-delay:-1s; }
        ...
        .glass { background:rgba(255,255,255,0.02); backdrop-filter:blur(24px) saturate(1.4); -webkit-backdrop-filter:blur(24px) saturate(1.4); }
        ...
        .shimmer { background:linear-gradient(90deg,transparent 0%,rgba(255,255,255,.05) 50%,transparent 100%); background-size:200% 100%; animation:shimmer 3s infinite; }
        ...
        .notification-card { animation:slide-in-r .7s cubic-bezier(.16,1,.3,1) .8s both; }
        .sale-card         { animation:slide-in-r .7s cubic-bezier(.16,1,.3,1) 1.1s both; }
        .ai-card           { animation:slide-in-r .7s cubic-bezier(.16,1,.3,1) 1.4s both; }
        .section-divider   { height:1px; background:linear-gradient(90deg,transparent,rgba(99,102,241,.15),transparent); }
      `}</style>
      ...
      {/* ══ NAVBAR ══════════════════════════════════════════════════════════════ */}
      <nav className={`fixed inset-x-0 z-[100] transition-all duration-700 top-[30px] ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/register')}
              className="px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest text-white transition-all duration-300 hover:-translate-y-0.5 active:scale-95"
              style={{ background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', boxShadow: '0 8px 25px -6px rgba(99,102,241,.55)' }}>
              Empezar gratis
            </button>
          </div>
        </div>
      ...
      <section ref={heroRef} className="relative pt-44 pb-24 overflow-hidden min-h-screen flex items-center">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[700px] opacity-[0.22]"
            style={{ background: 'radial-gradient(ellipse at 50% 30%, rgba(99,102,241,.55) 0%, rgba(139,92,246,.18) 40%, transparent 70%)' }} />
          <div className="absolute bottom-0 right-0 w-[600px] h-[600px] opacity-[0.08]"
            style={{ background: 'radial-gradient(ellipse, rgba(139,92,246,.7), transparent 70%)' }} />
          <div className="absolute top-1/4 left-0 w-[400px] h-[400px] opacity-[0.06]"
            style={{ background: 'radial-gradient(ellipse, rgba(56,189,248,.5), transparent 70%)' }} />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="hidden lg:block relative h-[520px]">
              <div className="absolute inset-x-0 top-8 rounded-3xl border border-white/[0.08] p-6 float-a shadow-2xl shadow-black/40" style={{ background: 'rgba(10,14,26,.92)', backdropFilter: 'blur(24px) saturate(1.3)', WebkitBackdropFilter: 'blur(24px) saturate(1.3)' }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20" data-reveal>
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.04em] text-white">
              Todo conectado.<br /><span className="text-white/[0.18]">Nada duplicado.</span>
            </h2>
            <p className="text-white/25 text-base mt-5 max-w-xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-12 gap-5">
            {/* POS */}
            <div data-reveal className="md:col-span-8 rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/40 to-[#020710] p-10 relative overflow-hidden group hover:border-indigo-500/35 transition-all duration-500">
            ...
            {/* VisionLab */}
            <div data-reveal className="md:col-span-4 rounded-3xl border border-violet-500/20 bg-gradient-to-br from-violet-950/40 to-[#020710] p-10 flex flex-col justify-between group hover:border-violet-500/35 transition-all duration-500">
              <div>
            ...
            {/* Inventario */}
            <div data-reveal className="md:col-span-4 rounded-3xl bg-gradient-to-br from-emerald-950/30 to-[#020710] border border-emerald-500/20 p-10 flex flex-col justify-between group hover:border-emerald-500/35 transition-all duration-500">
              <div>
            ...
            {/* RRHH */}
            <div data-reveal className="md:col-span-4 rounded-3xl bg-gradient-to-br from-sky-950/30 to-[#020710] border border-sky-500/20 p-10 flex flex-col justify-between group hover:border-sky-500/35 transition-all duration-500">
              <div>
            ...
            {/* Tasas BCV */}
            <div data-reveal className="md:col-span-8 rounded-3xl bg-gradient-to-br from-amber-950/30 to-[#020710] border border-amber-500/20 p-10 flex flex-col md:flex-row gap-8 items-center group hover:border-amber-500/35 transition-all duration-500">
      ...
      <section className="py-32 bg-[#070b14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16" data-reveal>
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.04em] text-white">
              Transparencia total.<br /><span className="text-white/[0.18]">Lo que hay y lo que viene.</span>
            </h2>
                ...
                {[
                  ...
                  return (
                    <div key={item.title} className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-colors">
                      ...
                      <p className="text-[11px] text-white/[0.28] leading-relaxed">{item.desc}</p>
                    </div>
                  );
                })}
              </div>
      ...
      <section className="py-32 bg-[#020508] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16" data-reveal>
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.04em] text-white">
              En todas tus pantallas.<br /><span className="text-white/[0.18]">Un sistema, todas las plataformas.</span>
            </h2>
      ...
      <section ref={modulesRef} className="py-32 bg-[#020508]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16" data-reveal>
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.04em] text-white">
              16 modulos.<br /><span className="text-white/[0.18]">Un solo login.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {MODULES.map((m, i) => {
              const Icon = m.icon;
              return (
                <div key={i} data-reveal className={`rounded-2xl border ${m.border} ${m.bg} p-5 group hover:brightness-125 transition-all duration-300 cursor-default`}>
                  ...
                  <p className="text-[11px] text-white/[0.28] leading-relaxed">{m.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14" data-reveal>
            ...
            <p className="text-white/[0.22] text-sm mt-4 max-w-xl mx-auto">Infraestructura de Google Firebase con cifrado en transito y en reposo. Aislamiento total entre empresas.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16" data-reveal>
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.04em] text-white mb-3">
              Precio simple.<br /><span className="text-white/[0.18]">Sin sorpresas.</span>
            </h2>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={f.label} className="flex items-center gap-2.5">
                    {f.ok ? <Check size={12} className="text-emerald-400 shrink-0" /> : <Minus size={12} className="text-white/[0.12] shrink-0" />}
            ...
            <div data-reveal className="relative rounded-3xl p-8 flex flex-col plan-card-popular" style={{ background: 'linear-gradient(160deg, rgba(79,70,229,0.12) 0%, rgba(13,20,36,1) 50%, rgba(2,7,16,1) 100%)', border: '1px solid rgba(99,102,241,0.4)' }}>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={f.label} className="flex items-center gap-2.5">
                    {f.ok === true ? <Check size={12} className="text-emerald-400 shrink-0" /> : f.ok === 'add' ? <Sparkles size={12} className="text-violet-400 shrink-0" /> : <Minus size={12} className="text-white/[0.12] shrink-0" />}
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-2">
            {FAQ_ITEMS.map((item, i) => (
              <div key={i} data-reveal className="rounded-2xl border border-white/[0.07] bg-white/[0.02] overflow-hidden hover:border-white/[0.12] transition-all duration-300">
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 opacity-[0.18]" style={{ background: 'radial-gradient(ellipse at 50% 100%, rgba(99,102,241,.55) 0%, rgba(139,92,246,.2) 35%, transparent 65%)' }} />
        </div>
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <div data-reveal>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button onClick={() => navigate('/register')}
                className="flex items-center gap-3 px-10 py-5 rounded-2xl text-base font-black uppercase tracking-widest text-white hover:-translate-y-1 active:scale-95 transition-all duration-300"
                style={{ background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', boxShadow: '0 20px 60px -12px rgba(99,102,241,.65), 0 0 120px -30px rgba(99,102,241,.3)' }}>
      ...
      {/* ══ FOOTER ═════════════════════════════════════════════════════════════ */}
      <footer className="border-t border-white/[0.06] py-16" style={{ borderImage: 'linear-gradient(90deg, transparent, rgba(99,102,241,.15), transparent) 1' }}>
        <div className="max-w-7xl mx-auto px-6">
