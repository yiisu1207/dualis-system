...
export type RoleKey = 'ventas' | 'auditor' | 'staff' | 'member';
...
export const PRESETS: Record<string, Partial<Record<ModuleId, boolean>>> = {
  'Cajero': {
    resumen: false, cajas: true, inventario: false, rrhh: false, sucursales: false,
  ...
  'Vendedor': {
    resumen: true, cajas: true, inventario: true, rrhh: false, sucursales: false,
    clientes: true, proveedores: false, contabilidad: false, fiscal: false,
